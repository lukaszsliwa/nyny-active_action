...
[![Gem Version](https://badge.fury.io/rb/nyny-active_action.svg)](https://badge.fury.io/rb/nyny-active_action)
[![License MIT](https://img.shields.io/github/license/lukaszsliwa/nyny-active_action)](https://github.com/lukaszsliwa/nyny-active_action/blob/main/LICENSE)
[![GitHub issues](https://img.shields.io/github/issues/lukaszsliwa/nyny-active_action)](https://github.com/lukaszsliwa/nyny-active_action/issues)
...
```rgem 'nyny-active_action', '~> 3.0.3'iginal gem:
